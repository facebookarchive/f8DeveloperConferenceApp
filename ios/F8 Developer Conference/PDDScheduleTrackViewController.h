...
@protocol PDDScheduleTrackViewControllerDelegate;

@interface PDDScheduleTrackViewController : PDDBaseListViewController
@property NSUInteger pageIndex;
@property (nonatomic, assign) NSObject<PDDScheduleTrackViewControllerDelegate> *delegate;
...
@protocol PDDScheduleTrackViewControllerDelegate <NSObject>
