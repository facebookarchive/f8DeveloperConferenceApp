...
@protocol PDDTrackViewDelegate;

@interface PDDTrackView : UIView

@property (nonatomic, assign) NSObject<PDDTrackViewDelegate> *delegate;
...
@protocol PDDTrackViewDelegate <NSObject>
